                    ...
                    @foreach($sproducts as $product)
                        <div class="product product-style-2 equal-elem ">
                            ...
                            <div class="product-info">
                                ...
                                <div class="wrap-price"><ins><p class="product-price">${{$product->sale_price}}</p></ins><del><p class="product-price">${{$product->regular_price}}</del> </div>
                            </div>
                        </div>
                    @endforeach
						...
						<div class="tab-contents">
							<div class="tab-content-item active" id="digital_1a">
								<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
									...
									<div class="product product-style-2 equal-elem ">
										<div class="product-thumnail">
											<a href="{{route('product.details',['slug'=>$late->slug])}}" title="{{$late->name}}">
												<figure><img src="{{asset('assets/images/products')}}/{{$late->image}}" width="800" height="800" ></figure>
											</a>
											<div class="group-flash">
												<span class="flash-item new-label">new</span>
											</div>
											<div class="wrap-btn">
												<a href="{{route('product.details',['slug'=>$late->slug])}}" class="function-link">quick view</a>
											</div>
										</div>
										<div class="product-info">
											<a href="{{route('product.details',['slug'=>$late->slug])}}" class="product-name"><span>{{$late->name}}</span></a>
                                            <div class="wrap-price"><ins><p class="product-price">${{$late->regular_price}}</p></ins>
                                        </div>
										</div>
									</div>
				...
				<div class="wrap-products">
					<div class="wrap-product-tab tab-style-1">
						<div class="tab-control">
                            @foreach( $categories_footer as $catoo)
                                @if( $catoo == current( $categories_footer) )
                                    <a href="#fashion_{{$catoo->id}}" class="tab-control-item active">{{$catoo->name}}</a>
                                @else
                                    <a href="#fashion_{{$catoo->id}}" class="tab-control-item">{{$catoo->name}}</a>
                                @endif
                            @endforeach
...
{{--							<a href="#fashion_1c" class="tab-control-item">Laptop</a>--}}
						...
						<div class="tab-contents">
@foreach($categories_footer as $caa )

							<div class="tab-content-item active" id="fashion_{{$caa->id}}">
								<div class="wrap-products slide-carousel owl-carousel style-nav-1 equal-container" data-items="5" data-loop="false" data-nav="true" data-dots="false" data-responsive='{"0":{"items":"1"},"480":{"items":"2"},"768":{"items":"3"},"992":{"items":"4"},"1200":{"items":"5"}}' >
)@foreach($CategoriesItems[$caa->id] as $product )
									<div class="product product-style-2 equal-elem ">
										<div class="product-thumnail">
											<a href="{{route('product.details',['slug'=>$product->slug])}}" title="{{$product->name}}">
												<figure><img src="{{asset('assets/images/products')}}/{{$product->image}}" width="800" height="800" ></figure>
											</a>
